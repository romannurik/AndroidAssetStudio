...
export function main(argv) {
	...
	const hostUrl = args['--local'] ? 'http://localhost:3000' : 'https://romannurik.github.io/AndroidAssetStudio'
	let paramPrefix = '#'
	...
	if(args['--help']) {
		...
		console.info(`    launcher-icon-generator    Opens a launcher icon generator with the given settings.`)
		console.info()
		...
		console.info(`    -p, --padding       Padding to the foreground from -0.1 to 0.5.`)
		...
		console.info(`    -e, --effect        Effect of the logo on its container.`)
		console.info(`                        Possible values: none, elevate, shadow, score`)
		...
		console.error(`Generator ${generator} was not found or has no available CLI module.`)
	}
